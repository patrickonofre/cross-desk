...
- [ ] **release-1.0 — Fase 3 feita, Fase 1 (gate) ainda bloqueada** (2026-07-07): `LICENSE` (MIT), `CHANGELOG.md` e roteiro `macos/.specs/project/UAT-1.0.md` prontos; README ganhou seção Instalação (`xattr -cr`) — status "MVP em validação" fica até o gate fechar (não é verdade ainda dizer "1.0 estável"). Nenhuma tag deletada, nenhuma versão bumpada, nenhum release publicado — Fases 2/4/5 esperam os 5 UATs de `UAT-1.0.md`.
